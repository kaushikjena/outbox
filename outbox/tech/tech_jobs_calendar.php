...
$cond="at.wo_no=wo.wo_no AND wo.client_id=c.id AND at.tech_id='$_SESSION[userid]' AND at.start_date BETWEEN '$FirstDate' AND '$LastDate'"; 
?>
<!-- Requied for Map --->
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function getCalData(parm1,parm2) {
			...
			$.ajax({
				async: false,
				url: 'ajax-calendar-source-tech.php',
				type: 'POST',
				dataType: 'json',
	...
	function showFilterMap(viewname,startdate,enddate){
		var url ="ajax-calendar-map-tech.php";
