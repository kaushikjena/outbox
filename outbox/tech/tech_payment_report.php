...
function Search_Records(){
	$("#SrchFrm").attr("action", "tech_payment_report");
	$("#SrchFrm").submit();
}
...
function print_doc(val,page){
 if(val=='word'){
	$("#SrchFrm").attr("action", "tech_payment_report_word");
	$("#SrchFrm").submit();
 }else if(val=='excell'){
	$("#SrchFrm").attr("action", "tech_payment_report_excell");
	$("#SrchFrm").submit(); 
 }else if(val=='pdf'){
	$("#SrchFrm").attr("action", "tech_payment_report_pdf");
	$("#SrchFrm").submit(); 
 }else if(val=='print'){
	$("#SrchFrm").attr("action", "tech_payment_report_print?page="+page);
            		...
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                          ...
                          <?php
                                    ...
                                    <tbody>
									 ...
									 ?>
										...
										?>   
                                            ...
                                            <td data-title="Customer State"><?php echo $res_jobPayment['state_name'];?></td>
                           ...
                           <div class="spacer"></div>
                           <?php }else{?>
                              <div style="padding-left:40%;border:1px solid #ccc;color:#F00;">No records founds!!</div>
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"tech_payment_report.php?srchCust=$_REQUEST[srchCust]&srchState=$_REQUEST[srchState]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&");}?></div>
                          </div>
                        </div>
                        <div class="spacer"></div>
                    </div>
