...
if($_REQUEST['action']=="insert"){
	...
	//update work_order table
	 $string="work_status='$_REQUEST[cmbStatus]',serial_number='$_REQUEST[SerialNumber]',model_number='$_REQUEST[ModelNumber]',parts_status='$_REQUEST[partStatus]',updated_date=now(),updated_by='$_SESSION[userid]'";
                    ...
                    <!-----address div start--------->
                     <div  class="divTechworkStatus">
                       ...
                       <div class="spacer"></div>
                        ...
                        <div  class="textboxcjob"><input type="text" class="textboxjob" name="SerialNumber" id="SerialNumber"  value=""><br/><label for="SerialNumber" id="lblSerialNumber" class="redText"></label></div>
                       <div  class="formtextaddjoblong">Model Number:<span class="redText">*</span></div>
                       <div  class="textboxcjob"><input type="text" class="textboxjob" name="ModelNumber" id="ModelNumber"><br/><label for="ModelNumber" id="lblModelNumber" class="redText"></label></div>                    
                       <div class="spacer"></div>
