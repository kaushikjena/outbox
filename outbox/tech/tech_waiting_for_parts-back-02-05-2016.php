...
<?php
	...
	if($_REQUEST['id']<>''){ 
		...
		if($admin_notification==1){
			...
			$body =str_replace(array('%AdminName%','%CustomerName%','%PurchaseOrder%','%WorkOrder%','%ClientName%'),array($AdminName,$customerName,$purchaseOrder,$res_wo['wo_no'],$clientName),$input);
