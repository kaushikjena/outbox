...
if($_REQUEST['action']=="insert"){
	...
	//update work_order table
	 $string="work_status='$_REQUEST[cmbStatus]',serial_number='$_REQUEST[SerialNumber]',model_number='$_REQUEST[ModelNumber]',updated_date=now(),updated_by='$_SESSION[userid]'";
