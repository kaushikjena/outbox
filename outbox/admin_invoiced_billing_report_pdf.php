...
$filename = "admin_invoiced_billing_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_invoiced_billing_report_pdf_data.php?srchClient=$creatorlist&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
