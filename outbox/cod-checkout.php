...
//get amount
$amount = $dbf->getDataFromTable("work_order_bill","subtotal","wo_no='$_REQUEST[wono]' AND client_id='$_REQUEST[cid]' and payment_status='Pending'");
//client details
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                        <!-----Table area start------->
                          <form name="frmCkeckout" id="frmCkeckout" action="cod-checkout-process" method="post" onSubmit="return validate_checkout();" autocomplete="off">
                            ...
                            <div class="innerBilling">
                                ...
                                <input type="button" class="buttonText3" value="Back" onClick="javascript:window.location.href='index'" tabindex="10">
                             </div>
                          	<div class="spacer"></div>
                           	</div>
                        	</div>
