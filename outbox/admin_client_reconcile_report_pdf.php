...
$filename = "admin_client_reconcile_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_client_reconcile_report_pdf_data.php?srchClient=$creatorlist&srchStatus=".urlencode($_REQUEST['srchStatus'])."&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
