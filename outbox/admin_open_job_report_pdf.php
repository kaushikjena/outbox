...
$filename = "admin_open_job_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_open_job_details_pdf_data.php?srchClient=$_REQUEST[srchClient]&Delivrywo=$_REQUEST[Delivrywo]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
