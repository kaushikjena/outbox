         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                    	<form name="SrchFrm" id="SrchFrm" action="client-manage-job-board-assign" method="post">
                        ...
                        <div class="headerbg">
                            ...
                            <div  style="float:left; text-transform:none; padding-left:100px;">( This filter applies to: Assign Board )</div>
                            ...
                            <input type="button" class="buttonText2" value="Return Back" onClick="document.location.href='client-manage-job-board-assign'"/></div>
                        </div>
                        ...
                        <div class="divFilterleftOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order wo,clients cl","wo.client_id=cl.id AND wo.created_by='$_SESSION[userid]' AND wo.work_status='Assigned'","cl.name ASC","","cl.name")as $customer){?>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.wo_no=at.wo_no AND at.tech_id=t.id  AND w.work_status='Assigned' AND w.approve_status='1' AND w.created_by='$_SESSION[userid]'","w.id","w.wo_no")as $reswono){?>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.wo_no=at.wo_no AND at.tech_id=t.id  AND w.work_status='Assigned' AND w.approve_status='1' AND w.created_by='$_SESSION[userid]' AND w.purchase_order_no <>''","w.id","w.purchase_order_no")as $respurno){?>
