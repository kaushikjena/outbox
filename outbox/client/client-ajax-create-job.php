...
//get client name
$resClient=$dbf->strRecordID("clients","name,tech_instruction","id='$_SESSION[userid]'");
$resUserName = $resClient['name'];
?>
         ...
         <div  style="margin:2px;">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg">ADD ORDER</div>
                          ...
                          <div class="spacer" style="height:12px;"></div>
                            ...
                            <!-----purchase div start--------->
                               ...
                               <div id="rescust">
                                ...
                                <div  class="textboxcjob">
                                    <input type="text" class="textboxjob" name="CustZip" id="CustZip" tabindex="20" maxlength="12"><br/><label for="CustZip" id="lblCustZip" class="redText"></label>
                                </div>
                            ...
                            <div  class="divPickup">
                                ...
                                <div  class="textboxcjob">
                                 <input type="text" class="textboxjob" name="carrier_company" id="carrier_company" tabindex="11"><br/><label for="carrier_company" id="lblcarrier_company" class="redText"></label>
                                </div>
                                <div class="spacer"></div>
