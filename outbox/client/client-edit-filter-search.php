         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                    	<form name="SrchFrm" id="SrchFrm" action="client-manage-job-board-dispatch" method="post">
                        ...
                        <div class="headerbg">
                            ...
                            <input type="button" class="buttonText2" value="Return Back" onClick="document.location.href='client-manage-job-board-dispatch'"/></div>
                        </div>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.wo_no=at.wo_no AND at.tech_id=t.id  AND w.work_status IN('Dispatched','In Progress','Completed','Ready to Invoice','Invoiced','Assigned') AND w.approve_status='1' AND w.created_by='$_SESSION[userid]'","w.id","w.wo_no")as $reswono){?>
