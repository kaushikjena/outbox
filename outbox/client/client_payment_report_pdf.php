...
$filename = "client_payment_report.pdf";
//$filepath="pdf_reports/".$filename;
 $htmlFile = $baseUrl."client/client_payment_report_pdf_data.php?srchCust=$_REQUEST[srchCust]&srchState=$_REQUEST[srchState]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]&userid=$_SESSION[userid]";
