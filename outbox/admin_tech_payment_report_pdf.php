...
$filename = "admin_tech_payment_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_tech_payment_report_pdf_data.php?srchTech=$_REQUEST[srchTech]&srchClient=$creatorlist&srchStatus=$_REQUEST[srchStatus]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
