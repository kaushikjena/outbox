...
if($_REQUEST['action']=="insert"){
	...
	$num=$dbf->countRows("equipment","service_id='$serviceName' AND equipment_name='$equipmentName'");
	if($num>0){
		header("Location:add-equipment?msg=002");exit;
	}else{
		$string="equipment_name='$equipmentName',service_id='$serviceName',created_date=now()";
		//insert into equipment table
		$dbf->insertSet("equipment",$string);
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolum">
            		<div class="rightcoluminner">
                        <div class="headerbg">ADD EQUIPMENT</div>
                            ...
                            <div class="spacer"></div>
                              ...
                              <div  class="formtextadd">Service Name<span class="redText">*</span></div>
                               ...
                               <div class="spacer"></div>
                                ...
                                <div  class="textboxc">
                                    <input type="text" class="textbox" name="equipmentName" id="equipmentName"><br/><label for="equipmentName" id="lblequipmentName" class="redText"></label>
                               </div>
                              <div class="spacer"></div>
                                 <div align="center">
