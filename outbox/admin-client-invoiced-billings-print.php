	  ...
	  <?php 
        ...
        <table  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#808080" width="100%" style="border:solid 1px #999;">
          	 <tr>
                ...
                <td width="53%" align="center" valign="middle" class="fetch_contents"><b>Client Invoiced Bill</b></td>
        ...
        <table height="61" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#808080" width="100%" style="border:solid 1px #999;"> 
            <tr>
                <td  style="color:#F00; font-family:Verdana, Geneva, sans-serif; font-weight:bold;font-size:12px;" align="center">&nbsp;</td>
            </tr>
        </table>
        ...
        <thead>
          <tr bgcolor="#E6F9D5">
            <th width="25%" height="27" align="left" valign="middle" class="fetch_headers">Equipment</th>
            <th width="50%" height="27" align="left" valign="middle" class="fetch_headers">Description</th>
          </tr>
        </thead>
        <tbody>
		<?php 
		...
		?>
          <tr>
            <td height="25" align="left" valign="middle" class="fetch_contents"><?php echo $resServicePrice['equipment_name'];?></td>
            <td height="25" align="left" valign="middle" class="fetch_contents"><?php echo $resServicePrice['item_notes'];?></td>
          </tr>
         <?php }} ?>
         </tbody>
       </table>
