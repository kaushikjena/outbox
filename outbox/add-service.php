...
if($_REQUEST['action']=="insert"){
	    $num=$dbf->countRows("service","service_name='$_REQUEST[ProfileServiceName]'");
		if($num>0){
			header("Location:add-service?msg=002");exit;
		}else{
			$ProfileServiceName=mysql_real_escape_string($_REQUEST['ProfileServiceName']);
		$string="service_name='$ProfileServiceName',created_date=now()";
		}
		//insert into Service table
		$dbf->insertSet("service",$string);
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolum">
            		<div class="rightcoluminner">
                        <div class="headerbg">ADD SERVICE</div>
                        ...
                        <div id="contenttable">
                            ...
                            <div class="spacer"></div>
                         	  <form action="" name="frmService" id="frmService" method="post" onSubmit="return validate_Service();" enctype="multipart/form-data" autocomplete="off">
                              <input type="hidden" name="action" value="insert">
                             	<div  class="formtextadd">Service Name<span class="redText">*</span></div>
                                <div  class="textboxc">
                                    <input type="text" class="textbox" name="ProfileServiceName" id="ProfileServiceName"><br/><label for="ProfileServiceName" id="lblProfileServiceName" class="redText"></label>
                               </div>
                              <div class="spacer"></div>
                                 <div align="center">
