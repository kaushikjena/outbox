            		...
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                            ...
                            <form name="SrchFrm" id="SrchFrm" action="" method="post">
							  ...
							  function getStartAndEndDate($week, $year) {
								...
								foreach($week_array as $k=>$w){
									...
									$qrydt = "SELECT w.wo_no FROM work_order w LEFT JOIN work_order_tech_bill wt ON w.wo_no=wt.wo_no WHERE w.work_status='Invoiced' AND w.invoiced_date BETWEEN $date_range AND (wt.payment_status <>'Completed' OR wt.payment_status is NULL)";
                            ...
                            <table id="no-more-tables" class="draggable">
								...
								<?php
                                    $resGrArray=array();
									$qryg = "SELECT t.first_name, t.middle_name, t.last_name, t.email, t.contact_phone, w.work_status, t.id FROM assign_tech at,technicians t,work_order w WHERE ".$cond." AND FIND_IN_SET(w.wo_no,'$implode_workorders') GROUP BY t.id";
									...
									$qry = "SELECT w.wo_no FROM assign_tech at,technicians t,work_order w WHERE t.id='$sgRes[id]' AND ".$cond." AND FIND_IN_SET(w.wo_no,'$implode_workorders')";
