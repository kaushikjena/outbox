...
$wono = $_REQUEST['wono'];
//client details
$resClientDetails = $dbf->fetchSingle("clients","id='$_REQUEST[clientid]'");
//admin details
            		...
            		<div class="rightcoluminner">
                        ...
                        <!-----Table area start------->
                            ...
                            <?php if($response_array[0]==1 && $response_array[2]==1){
								...
								$stringh="wo_no='$wono',client_id='$resClientDetails[id]', transaction_id='$response_array[37]', transaction_amount='$response_array[9]', payment_status='Completed', payment_date='$payment_date', created_date=now()";
								$dbf->insertSet("cod_payment_history",$stringh);
								//update work_order_bill table
								$dbf->updateTable("work_order_bill","payment_status='Completed',payment_date='$payment_date'","wo_no='$wono' AND created_by=0 AND client_id='$resClientDetails[id]'");
                                ...
                                <input type="button" class="buttonText3" value="Back" onClick="javascript:window.location.href='index'">
                             </div>
                          	<div class="spacer"></div>
                            <?php }else{?>
                            <div class="redText" align="center">Sorry!! Your Transaction failed.</div>
                            <div class="redText" align="center"><input type="button" class="buttonText3" value="Back" onClick="javascript:window.location.href='index'"></div>
                            <?php }?>
                           	</div>
                        	</div>
                            <!----- div billing end--------->
