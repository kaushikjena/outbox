...
<header>
    ...
    <div class="header">
        ...
        <form  action="manage-job-search" name="srchAdvance" id="srchAdvance" method="post">
        <div class="searchdiv">
        	
            <div class="seardivtxtbox"><input type="text" name="srchInputBox" id="srchInputBox" class="searchtextbox" value="<?php echo $_REQUEST['srchInputBox'];?>" placeholder="WO#,PO#,Customer name"/></div> 
            <div class="searchbtn"><input  type="image" src="images/find.png" title="Search"/></div>
            
        </div>
        </form>
        <form  action="manage-job-search-phone" name="srchAdvance" id="srchAdvance" method="post">
        <div class="searchdiv" style="width:200px;">
        	<div class="seardivtxtbox" style="width:175px;"><input type="text" name="srchInputBoxphno" id="srchInputBoxphno" class="searchtextbox" value="<?php echo $_REQUEST['srchInputBoxphno'];?>" placeholder="Phone Number"/></div> 
            <div class="searchbtn"><input  type="image" src="images/find.png" title="Search"/></div>
