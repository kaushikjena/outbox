...
header("Content-Disposition: attachment; Filename=admin_client_report.doc");
?>	
<!--Important-->
...
<body>
	  <?php 
       ...
       <table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#808080" width="100%" style="border:solid 1px #999;"> 
        ...
        <?php
         foreach($dbf->fetchOrder("state s,clients c",$cond,"c.id DESC","")as $res_client) {  //print "<pre>";print_r($res_tech);
        ?>
        <tbody>
          <tr>
