...
$filename = "admin_assigned_order_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_assigned_order_pdf_data.php?srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
