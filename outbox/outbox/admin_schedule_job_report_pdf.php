...
$filename = "admin_schedule_job_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_schedule_job_pdf_data.php?srchClient=$_REQUEST[srchClient]&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
