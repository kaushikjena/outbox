...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='insert'){
	...
	for($i=1;$i<=$count;$i++){
		...
		if($num>0){
			header("Location:add-service-price?msg=001");exit;
		}else{
			if($SpPrice==''){
				//insert string
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg">
                        	<div style="float:left;">Add Tech Payment Price</div>
                              ...
                              <input type="hidden" name="action" value="insert">
                                ...
                                <div  class="textboxcservice">
                                 <select class="selectbox" name="ServiceName" id="ServiceName" onChange="showEquipment(this.value);">
                                    ...
                                    <option value="<?php echo $vservice['id'];?>"><?php echo $vservice['service_name'];?></option>
                                    <?php }?>
                                  </select>
                                ...
                                <?php
							      ...
							      foreach($dbf->fetch("work_type","id>0 ORDER BY id ASC") as $vwtype){
							     ?>
                                <div  class="textboxserview"><input type="hidden" name="WorkType<?php echo $i;?>" value="<?php echo $vwtype['id'];?>"><?php echo $vwtype['worktype'];?></div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeA<?php echo $i;?>" id="PayGradeA<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeA" id="lblPayGradeA<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeB<?php echo $i;?>" id="PayGradeB<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeB" id="lblPayGradeB<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeC<?php echo $i;?>" id="PayGradeC<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeC" id="lblPayGradeC<?php echo $i;?>" class="redText"></label>
                                </div>
                               <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeD<?php echo $i;?>" id="PayGradeD<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeD" id="lblPayGradeD<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeE<?php echo $i;?>" id="PayGradeE<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeE" id="lblPayGradeE<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeF<?php echo $i;?>" id="PayGradeF<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeF" id="lblPayGradeF<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeG<?php echo $i;?>" id="PayGradeG<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeG" id="lblPayGradeG<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeH<?php echo $i;?>" id="PayGradeH<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeH" id="lblPayGradeH<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeI<?php echo $i;?>" id="PayGradeI<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeI" id="lblPayGradeI<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="PayGradeJ<?php echo $i;?>" id="PayGradeJ<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="PayGradeJ" id="lblPayGradeJ<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div class="spacer"></div>
                                <?php $i++; }?>
