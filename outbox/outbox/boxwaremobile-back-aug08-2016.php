<?php
	...
	if(isset($_REQUEST['method']) && $_REQUEST['method']=="submitschedule" && $_SERVER['REQUEST_METHOD']=='GET'){
		...
		if($num>0){
			...
			$body=str_replace(array('%AdminName%','%TechName%','%StartDate%','%StartTime%','%EndTime%','%WorkOrders%','%PurchaseOrder%'),array($AdminName,$TechName,$asgnStartDate,$asgnStartTime,$asgnEndTime,$WorkNo,$purchaseOrder),$input);
			...
			$subject1=$res_template['subject']."==".$clientName;
