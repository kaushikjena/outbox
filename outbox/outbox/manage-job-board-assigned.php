                            ...
                            <input type="hidden" name="page" value="AssignedBoard"/>
                              ...
                              <!-----Table area start------->
                                <table id="no-more-tables" class="draggable" border="0">
								    ...
								    <?php
										$resArray=$dbf->fetchOrder("state st,clients c,service s,technicians t,assign_tech at,work_order w","c.state='$sgRes[state]' AND " .$cond,$orderby." ".$orderType,"st.state_name, c.name , c.city, c.phone_no, w.id, w.wo_no, w.purchase_order_no, w.work_status, w.created_by, s.service_name, t.first_name, t.middle_name, t.last_name, at.assign_date",$groupby);
                                  ...
                                  <tr class="<?php echo $Cls;?> ro" <?php if($k!=0){?> style="display:none;"<?php }?>>
                                    ...
                                    <td data-title="CustomerPhone"><?php echo $res_JobBoard['phone_no'];?></td>
