...
$htmlFile = $baseUrl."admin-technician-invoiced-payment-pdf-data.php?action=payment&tid=$_REQUEST[tid]&billperiod=".urlencode($_REQUEST['billperiod'])."&wonos=".urlencode($_REQUEST['wonos'])."";
