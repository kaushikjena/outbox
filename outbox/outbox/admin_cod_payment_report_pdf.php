...
$filename = "admin_cod_payment_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_cod_payment_report_pdf_data.php?srchCust=$_REQUEST[srchCust]&srchTechnician=$_REQUEST[srchTechnician],FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
