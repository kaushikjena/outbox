...
if($_REQUEST['action']=="insert"){
	...
	if($numuser>0){
		...
		$string="name='$CustomerName',user_type='client', email='$_REQUEST[CustomerEmailID]', contact_name='$CustomercontactName', address='$CustAddress', city='$_REQUEST[CustCity]', state='$_REQUEST[CustState]', fax_no='$_REQUEST[Faxno]', zip_code='$_REQUEST[CustZip]', phone_no='$_REQUEST[CustPhone]', alt_phone='$_REQUEST[altCustPhone]', status=0, created_date=now()";
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <div class="headerbg">
                        	<div style="float:left;">CLIENT ADD JOB</div>
