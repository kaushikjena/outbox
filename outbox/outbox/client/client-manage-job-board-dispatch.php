...
function edit_filter(){
	window.location.href="client-edit-filter-search";
}
            		...
            		<div class="rightcoluminner">
                    	<?php
						  ...
						  // echo $cond;exit;
						   ...
						   elseif($sch==''){
							 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND  w.wo_no=at.wo_no AND at.tech_id=t.id  AND w.work_status='Assigned' AND w.approve_status='1' AND w.created_by='$_SESSION[userid]' AND at.start_date=CURDATE()";
						   }
						   //echo $cond;
						   ########Search condition start here ###############
						   //total order count
						  ...
						  ?>
                        <div class="headerbg">
                        	<div style="float:left; width:30%;">Client-Dispatch-Order-Board</div>
