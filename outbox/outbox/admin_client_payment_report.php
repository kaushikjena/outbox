...
function Search_Records(){
	$("#SrchFrm").attr("action","admin_client_payment_report");
	$("#SrchFrm").submit();
}
function ClearFields(){
	...
	window.location.href="admin_client_payment_report";
}
//for exporting,print,pdf,word
function print_doc(val,page){
 if(val=='word'){
	$("#SrchFrm").attr("action","admin_client_payment_report_word");
	$("#SrchFrm").submit();
 }else if(val=='excell'){
	$("#SrchFrm").attr("action","admin_client_payment_report_excell");
	$("#SrchFrm").submit(); 
 }else if(val=='pdf'){
	$("#SrchFrm").attr("action","admin_client_payment_report_pdf");
	$("#SrchFrm").submit(); 
 }else if(val=='print'){
	$("#SrchFrm").attr("action","admin_client_payment_report_print?page="+page);
                        ...
                        <div id="contenttable">
                          ...
                          <?php
                                    ...
                                    <?php 
									 ...
									 ?>
                                    	<tr style="background-color:#f9f9f9;">
                                            ...
                                            <div class="divgr">
                                            <span style="color:#ff9812;">Client &raquo; <?php echo $sgRes['name'];?></span></div>
                                            </td>
                                            <td class="hiderow">&nbsp;</td>
                                            <td class="hiderow">&nbsp;</td>
                                            <td class="hiderow">&nbsp;</td>
										...
										?>
                                        <tr>
                                            <td data-title="WO#" class="coltext"><?php echo $res_clientPayment['wo_no'];?></td>
                                            <td data-title="Client Name" class="coltext"><?php echo $res_clientPayment['name'];?></td>
                                            <td data-title="Email ID"><?php echo $res_clientPayment['email'];?></td>
                                            <td data-title="Contact No"><?php echo $res_clientPayment['phone_no'];?></td>
                                            <td data-title="Tech Name"><?php echo $res_clientPayment['first_name'].'&nbsp;'.$res_clientPayment['middle_name'].'&nbsp;'.$res_clientPayment['last_name'];?></td>
                                            <td data-title="Payment Date"><?php echo date("d-m-Y",strtotime($res_clientPayment['payment_date']));?></td>
                                            <td data-title="Amount" style="text-align:center;"><?php echo $res_clientPayment['subtotal'];?></td>
                           ...
                           <?php }else{?>
                            ...
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"admin_client_payment_report?srchClient=$_REQUEST[srchClient]&srchTechnician=$_REQUEST[srchTechnician]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&");}?></div>
                          </div>
                        </div>
                        <div class="spacer"></div>
                    </div>
