...
$filename = "admin_client_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_client_report_pdf_data.php?Delivrycity=$_REQUEST[Delivrycity]&Delivrystate=$_REQUEST[Delivrystate]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
