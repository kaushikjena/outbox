...
$filename = "admin_technician_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_technician_report_pdf_data.php?Delivrycity=$_REQUEST[Delivrycity]&Delivrystate=$_REQUEST[Delivrystate]&TechStatus=$_REQUEST[TechStatus]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
