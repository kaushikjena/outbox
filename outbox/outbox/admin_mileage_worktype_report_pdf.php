...
$filename = "admin_mileage_worktype_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_mileage_worktype_pdf_data.php?srchClient=$creatorlist&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
