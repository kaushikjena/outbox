...
?>
    ...
    <div  class="textboxcjob">
        <input type="text" class="textboxjob" name="CustomerName" id="CustomerName" value="<?php echo $resCust['name'];?>" onKeyPress="return onlyLetters(event)"><br/><label for="CustomerName" id="lblCustomerName" class="redText"></label>
    </div>
    ...
    <div  class="textboxcjob">
      <input type="text" class="textboxjob" name="CustomercontactName" id="ContactName" value="<?php echo $resCust['contact_name'];?>" onKeyPress="return onlyLetters(event)"><br/><label for="CustomercontactName" id="lblCustomercontactName" class="redText"></label>
    </div>
     <div class="spacer"></div>
     <div  class="formtextaddjob">City:<span class="redText">*</span></div>
    <div  class="textboxcjob">
        <input type="text" class="textboxjob" name="CustCity" id="CustCity" value="<?php echo $resCust['city'];?>" onKeyPress="return onlyLetters(event)"><br/><label for="CustCity" id="lblCustCity" class="redText"></label>
    </div>
    ...
    <div  class="textboxcjob">
        <input type="text" class="textboxjob" name="CustZip" id="CustZip" value="<?php echo $resCust['zip_code'];?>" maxlength="12"><br/><label for="CustZip" id="lblCustZip" class="redText"></label>
    </div>
    <div  class="formtextaddjoblong">Phone No:<span class="redText">*</span></div>
    <div  class="textboxcjob">
        <input type="text" class="textboxjob" name="CustPhone" id="CustPhone" onKeyPress="return onlyNumbers(event);" value="<?php echo $resCust['phone_no'];?>" maxlength="12"><br/><label for="CustPhone" id="lblCustPhone" class="redText"></label>
    </div>
     <div class="spacer"></div>
    <div  class="formtextaddjob">Cell No:</div>
     <div  class="textboxcjob">
        <input type="text" class="textboxjob" name="Faxno" id="Faxno" onKeyPress="return onlyNumbers(event);"value="<?php echo $resCust['fax_no'];?>" maxlength="12"><br/><label for="Faxno" id="lblFaxno" class="redText"></label>
