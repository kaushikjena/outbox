...
$filename = "admin_client_payment_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_client_payment_report_pdf_data.php?srchClient=$creatorlist&srchTechnician=$_REQUEST[srchTechnician]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
