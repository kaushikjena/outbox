...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <meta name="viewport" content="width=device-width, maximum-scale = 1, minimum-scale=1">
   ...
   <!-- <script type="text/javascript" src="ckeditor/sample.js"></script>-->
	...
	<!--Autocomplte--> 
    <noscript>    
        <div style="text-align:center;position: fixed; top: 0px; left: 0px;padding-top:200px; z-index:9999; height: 100%; width: 100%; background-image:url(images/disables.gif);">
...
<?php 
if(isset($_SESSION['userid']) && $_SESSION['userid']!='' && $_SESSION['usertype']!=''){
