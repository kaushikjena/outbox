...
$resWork = $dbf->fetchSingle("work_type","id='$_REQUEST[id]'");
if($_REQUEST['action']=="update"){
	$WorkTypeName=mysql_real_escape_string($_REQUEST['WorkTypeName']);
	$num=$dbf->countRows("work_type","worktype='$WorkTypeName' AND id<>'$_REQUEST[hid]'");
	if($num>0){
		header("Location:edit-worktype?msg=002&id=$_REQUEST[hid]");exit;
	}else{
		$string="worktype='$WorkTypeName',created_date=now()";
		//update work_type table
		$dbf->updateTable("work_type",$string,"id='$_REQUEST[hid]'");
            		...
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                            ...
                            <div class="spacer"></div>
                              ...
                              <input type="hidden" name="hid" value="<?php echo $resWork['id'];?>"/>
                             	<div  class="formtextadd">WorkType Name<span class="redText">*</span></div>
                                <div  class="textboxc">
                                    <input type="text" class="textbox" name="WorkTypeName" id="WorkTypeName" value="<?php echo $resWork['worktype'];?>"><br/><label for="WorkTypeName" id="lblWorkTypeName" class="redText"></label>
                               </div>
                              <div class="spacer"></div>
                                 <div align="center">
