...
function Search_Records(){
	$("#SrchFrm").attr("action","admin_job_payment_report");
	$("#SrchFrm").submit();
}
function ClearFields(){
	...
	/*below line added to refresh page as to prevent url 
	mismatch problem in search using pagination.*/
	window.location.href="admin_job_payment_report";
}
//for exporting,print,pdf,word
function print_doc(val,page){
 if(val=='word'){
	$("#SrchFrm").attr("action","admin_job_payment_report_word");
	$("#SrchFrm").submit();
 }else if(val=='excell'){
	$("#SrchFrm").attr("action","admin_job_payment_report_excell");
	$("#SrchFrm").submit();
 }else if(val=='pdf'){
	$("#SrchFrm").attr("action","admin_job_payment_report_pdf");
	$("#SrchFrm").submit();
 }else if(val=='print'){
	$("#SrchFrm").attr("action","admin_job_payment_report_print?page="+page);
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg">
                            <div style="float:left;;">Total JOb Payment Report</div>
                        ...
                        <div id="contenttable">
                          ...
                          <?php
                                    ...
                                    <?php 
									 ...
									 ?>
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="Customer Name" class="coltext"><?php echo $res_jobPayment['name'];?></td>
                           ...
                           <?php }else{?>
                            ...
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"admin_job_payment_report?srchCust=$_REQUEST[srchCust]&srchClient=$_REQUEST[srchClient]&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&");}?></div>
                          </div>
                        </div>
                        <div class="spacer"></div>
                    </div>
