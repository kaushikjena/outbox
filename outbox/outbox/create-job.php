...
if(isset($_REQUEST['action']) && $_REQUEST['action']=="insert" && $_SERVER['REQUEST_METHOD']=='POST'){
	...
	if($_REQUEST['custid']){
		...
		if($_FILES['fileUpload']['name']<>''){
			...
			$string3="workorder_id='$woid', wo_document='$file_name',created_date=now(),created_user='$_SESSION[userid]', user_type='$_SESSION[usertype]',unread=0";
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <div class="headerbg">
                        	<div style="float:left;">ADD ORDER</div>
                        ...
                        <!-----Table area start------->
                            ...
                            <div  class="divNotes">
                             ...
                             <div><textarea name="notes" id="notes"  class="textareaOrder" tabindex="22" style="min-height:120px;"></textarea><br/><label for="notes" id="lblnotes" class="redText"></label></div>
                             <div class="spacer" ></div> 
                             <div  class="formtextaddjob">Upload Doc:</div>
                              	<div  class="textboxcjob" style="width:500px;"><input type="file" name="fileUpload" id="fileUpload" tabindex="22"/>
                             	</div>
                                <div class="spacer" ></div> 
                            </div>
                            <!-----note div end--------->
                            ...
                            <div  class="divPickup" style="margin-top:5px;">
                                ...
                                <div  class="textboxcjob">
                                <input type="text" class="textboxjob datepick" name="partsArrive" id="partsArrive" readonly value="">
                                <br/><label for="partsArrive" id="lblpartsArrive" class="redText"></label>  
                                </div>
                            ...
                            <div  class="divService">
                            	<div class="greenText" align="left">Tech Instruction:</div>
                             	<div style="color:#C69; font-weight:bold;" id="techInstruction">Tech instruction given by client will display here.</div>
                                <div class="spacer"></div>
                            </div>
                            <!-----Tech Instruction start--------->
                        	<div class="spacer"></div>
