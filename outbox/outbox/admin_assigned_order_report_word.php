...
header("Content-Disposition: attachment; Filename=admin_assigned_order_report.doc");
?>	
<!--Important-->
       ...
       <table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#808080" width="100%" style="border:solid 1px #999;"> 
        ...
        ?>
         <tr>
			...
			<?php if($res_JobBoard['work_status']<>''){?><?php echo $res_JobBoard['work_status'];?><?php } else{echo 'Not Started';}?></td>
