...
<div id="navmenu">
    <ul>
       ...
       <li class="has-sub"><a href="#">Email Templates</a>
          <ul>
            <li class="has-child"><a href="#">General Emails</a>
                <ul>
            ...
            <li class="has-child"><a href="#">Client Emails</a>
                <ul>
            ...
            <li class="has-child"><a href="#">Tech Emails</a>
                <ul>
            ...
            <li class="has-child"><a href="#">Admin Emails</a>
                <ul>
       ...
       <li  class="has-sub"><a href="#">Service Calls</a>
         <ul>
            ...
            <li><a href="manage-job-board-pending">Pending Board</a></li>
            ...
            <li><a href="send-mass-sms">Send Group SMS</a></li>
            <li><a href="admin_assigned_orders">Assigned Orders Without Tech</a></li>
         </ul>
       </li>
       ...
       <li class="has-sub"><a href="#">Reports</a>
         <ul>
         	<li class="has-child"><a href="#">General Reports</a>
                <ul>
            ...
            <li class="has-child"><a href="#">Payment Reports</a>
                <ul>
            ...
            <li class="has-child"><a href="#">Order Reports</a>
                <ul>
       ...
       <li class="has-sub"><a href="#">Settings</a>
       	<ul>
            ...
            <li><a href="manage-tech-sms-template">Tech SMS Template</a></li>
            <li><a href="manage-client-sms-template">Client SMS Template</a></li>
            <li><a href="admin-manage-email-notification">Admin Email Notifications</a></li>
