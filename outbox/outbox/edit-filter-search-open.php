         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                    	<form name="SrchFrm" id="SrchFrm" action="manage-job-board" method="post">
                        ...
                        <div class="headerbg">
                            ...
                            <input type="button" class="buttonText2" value="Return Back" onClick="document.location.href='manage-job-board'"/></div>
                        </div>
                        ...
                        <div class="divFilterleftOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order wo,clients cl","wo.client_id=cl.id AND wo.work_status='Open'","cl.name ASC","","cl.name")as $customer){?>
                        ...
                        <div class="divFiltercentOpen2">
                            ...
                            <div class="divFilterconsec">
								...
								$cond="wo.created_by=cl.id AND wo.created_by<>'0' AND wo.work_status='Open'";
								//condition for users
								if($implode_clients <>''){
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order w","w.work_status='Open' AND w.approve_status='1'","w.id","w.wo_no")as $reswono){?>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order w","w.work_status='Open' AND w.approve_status='1' AND w.purchase_order_no <>''","w.id","w.purchase_order_no")as $respurno){?>
