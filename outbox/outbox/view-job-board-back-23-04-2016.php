            		...
            		<div class="rightcoluminner">
                        ...
                        <!-----Table area start------->
                           ...
                           <div class="spacer"></div>                           
                            ...
                            <?php if($resTech<>''){
									if($res_viewJobBoard['work_status']=='Assigned'){?><a href="javascript:void(0);" onClick="Set_Workstatus('<?php echo $res_viewJobBoard['id'];?>')" title="View Time Window">Tech Time Window</a> <?php }else{?> <a href="javascript:void(0);" title="View Time Window">Tech Time Window</a><?php }}else{?> <a href="javascript:void(0);" title="View Time Window">Tech Time Window</a> <?php }?></span> </div>
