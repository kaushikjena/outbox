...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='payment'){
		...
		$email_body=str_replace(array('%ClientName%','%BillPeriod%','%WoNo%','%PurchaseOrder%','%Subtotal%','%ActivationLink%'),array($codname,"Nill",$_REQUEST['wonos'],$purchase_order,number_format($_REQUEST['amount'],2),$activateUrl),$input);
		...
		header("Location:manage-client-invoiced-billings");exit;
}
######################EMAIL SENDING END ################################## 						 
?>
<body>
...
function print_doc(val){
 if(val=='print'){
	...
	if(x){
		$("#frmClient").attr("action","admin-client-invoiced-billings-print");
...
function sendClient(){
	$("#frmClient").attr("action","admin-client-invoiced-billings");
	$("#frmClient").submit();
}
</script>
    <div id="maindiv">
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <!-----Table area start------->
                         <!-----Billing div start--------->
                          <div  class="divBilling">
                            <div class="greenText" align="center">Total Work Order Invoiced Bill</div>
                            ...
                            <div  class="textboxbillview">Nill</div>
                        ...
                        <div align="center">
                        <input type="button" class="buttonText" value="Return Back" onClick="window.location='manage-client-invoiced-billings'"/> 
