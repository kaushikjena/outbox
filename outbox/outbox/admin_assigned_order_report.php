...
function Search_Records(){
	$("#SrchFrm").attr("action","admin_assigned_order_report");
	$("#SrchFrm").submit();
}
function ClearFields(){
	...
	$('#ToDate').val("");
	$('#hidaction').val("");
	window.location.href="admin_assigned_order_report";
}
//for exporting,print,pdf,word
function print_doc(val,page){
 if(val=='word'){
	$("#SrchFrm").attr("action","admin_assigned_order_report_word.php");
	$("#SrchFrm").submit();
 }else if(val=='excell'){
	$("#SrchFrm").attr("action","admin_assigned_order_report_excell");
	$("#SrchFrm").submit();
 }else if(val=='pdf'){
	$("#SrchFrm").attr("action","admin_assigned_order_report_pdf.php");
	$("#SrchFrm").submit();
 }else if(val=='print'){
	$("#SrchFrm").attr("action","admin_assigned_order_report_print.php?page="+page);
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg">
                            <div style="float:left;;">Assigned Jobs Report</div>
                        ...
                        <div id="contenttable">
                           ...
                           <div class="table">
                            <div class="table-head">
                                ...
                                <div class="column" data-label="CreatedDate" style="width:8%;">AssignedDate</div>
                                ...
                                <div class="column" data-label="PickupAddress" style="width:8%;">DeliveryAddress</div>
                                <div class="column" data-label="PickupZipcode" style="width:10%;">DeliveryZipcode</div>
                                <div class="column" data-label="PickupPhone" style="width:10%;">DeliveryPhone</div>
                           ...
                           <?php
                            ...
                            <div class="row">
                                ...
                                <div class="column" data-label="CreatedDate"><?php if($res_JobBoard['assign_date']!='0000-00-00'){echo date("d-M-Y",strtotime($res_JobBoard['assign_date']));}?></div>
                                ...
                                <div class="column" data-label="PickupAddress"><?php echo $res_JobBoard['address'];?></div>                                <div class="column" data-label="PickupZipcode"><?php echo $res_JobBoard['zip_code'];?></div>                          
                                <div class="column" data-label="PickupPhone"><?php echo $res_JobBoard['phone_no'];?></div>                            
						 ...
						 <?php }else{?>
                            ...
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"admin_assigned_order_report?srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&");}?></div>
