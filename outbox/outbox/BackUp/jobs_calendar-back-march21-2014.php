                                    ...
                                    <script type="text/javascript" src="js/jquery.calendario.js"></script>
                                        <script type="text/javascript">	
                                            ...
                                            <?php 
												...
												$resArray = $dbf->fetchOrder("assign_tech at,work_order wo"," at.wo_no=wo.wo_no  AND at.start_date='$v'","","at.start_date,wo.id,at.wo_no");
												$string='';
												if(count($resArray) > 1){
													foreach($resArray as $resevent) {
														...
														$string.= "<a href=".$linkhref." target=".$target.">$resevent[wo_no]</a>";
													}
														echo "'$eventdt' : '".$string."',";	
												}else{
													foreach($resArray as $resevent) {
														$eventdt= date("m-d-Y",strtotime($resevent['start_date']));
														$linkhref="view-job-board?id=$resevent[id]&src=cal"; $target = "_self";
														echo "'$eventdt' : '<a href=".$linkhref." target=".$target.">$resevent[wo_no]</a>',";
													}
												}
												}
                                            ?>
