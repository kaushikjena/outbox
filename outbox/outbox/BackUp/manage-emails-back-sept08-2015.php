                        	...
                        	<div style="width:100%;float:left;">
                              <div class="table">
                                <div class="table-head">
                                    ...
                                    <div class="column" data-label="Email"  style="width:40%;">Email</div>
                                    <div class="column" data-label="Name" style="width:25%;">Name</div>  					
                                ...
                                <div class="row">
                                    ...
                                    <div class="column" data-label="email"><?php echo $res_email['email'];?></div>                                    
                                    <div class="column" data-label="name"><?php echo $res_email['name'];?></div>                                   
