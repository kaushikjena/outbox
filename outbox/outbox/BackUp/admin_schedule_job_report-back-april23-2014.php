...
function Search_Records(){
	document.SrchFrm.action="admin_schedule_job_report";
...
function print_doc(val,page){
 if(val=='word'){
	 document.SrchFrm.action="admin_schedule_job_report_word";
	 document.SrchFrm.submit();
 }else if(val=='excell'){
	 document.SrchFrm.action="admin_schedule_job_report_excell";
	 document.SrchFrm.submit(); 
 }else if(val=='pdf'){
	 document.SrchFrm.action="admin_schedule_job_report_pdf";
	 document.SrchFrm.submit(); 
 }else if(val=='print'){
	document.SrchFrm.action="admin_schedule_job_report_print?page="+page;
                        ...
                        <div id="contenttable">
                            ...
                            <form name="SrchFrm" id="SrchFrm" action="" method="post">
							  ...
							  // echo $cond;exit;
							   ...
							   elseif($sch==''){
								 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND w.job_status='Assigned' AND w.approve_status='1' AND w.wo_no=at.wo_no AND at.tech_id=t.id";
							   }
							   //print $cond;
							   //Pagination 
                           ...
                           <div class="table">
                            <div class="table-head">
                                ...
                                <div class="column" data-label="JobStatus" style="width:6%;">JobStatus</div>
                                <div class="column" data-label="JobStatus" style="width:6%;">workStatus</div>
                           ...
                           <?php
                            ...
                            <div class="row">
                                ...
                                <div class="column" data-label="JobStatus" style="font-weight:bold;"><?php echo $res_JobBoard['job_status'];?></div>
