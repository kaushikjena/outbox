...
if(isset($_REQUEST['action']) && $_REQUEST['action']=="update" && $_SERVER['REQUEST_METHOD']=='POST'){
	...
	###########Track user activity in work order notes table#############
	header("Location:edit-job-board-assign?id=$_REQUEST[worid]&msg=001&src=assigned");exit;
}
                    ...
                    <form name="createJob" id="createJob" action="" method="post" onSubmit="return validate_createjob();" autocomplete="off" enctype="multipart/form-data">
                        <div class="headerbg">
                            ...
                            <div style="float:right;">
								...
								<?php if($_REQUEST['src']=='disp'){$path="manage-job-board-dispatch";}elseif($_REQUEST['src']=='assigned'){$path="manage-job-board-assigned";}?>
                        ...
                        <!-----Table area start------->
                            ...
                            <select name="cmbClient" id="cmbClient" class="selectboxjob" tabindex="1" onChange="showEquipment();">
                           ...
                           <div class="spacer" style="height:12px;"></div>
                            ...
                            <div  class="divPickup">
                                ...
                                <div class="spacer"></div>
                                <div  class="formtextaddjob">&nbsp;</div>
                             	<div  class="textboxcjob" style="width:500px; text-align:right;"><span class="purpleText"><a href="javascript:void(0);" onClick="showTechInstruction();"><img src="images/tech_instruction.png" title="Tech Instruction" alt="Tech Instruction"/>Tech Instruction</a></span></div>
                             	<div class="spacer"></div>
                            </div>
                            <!-----pickup div end--------->
                            <!-----note div start--------->
                            ...
                            <?php if($res_editJobBoard['created_by'] <>0){ 
							$techInstruction = $dbf->getDataFromTable("clients","tech_instruction","id='$res_editJobBoard[created_by]'");
							$techInstruction = ($techInstruction !='')?$techInstruction :"Not given by client.";
							?>
                            <div  class="divService">
                            	<div class="greenText" align="left">Tech Instruction:</div>
                             	<div style="min-height:60px;color:#C69;"><?php echo $techInstruction;?></div>
                                <div class="spacer"></div>
                            </div>
                            <?php }?>
                            <!-----Tech Instruction start--------->
