                        ...
                        <div id="contenttable">
                            ...
                            <form name="SrchFrm" id="SrchFrm" action="" method="post">
                              ...
                              <?php
							   ...
							   //echo $sch;exit;
							   if($sch!=''){
								 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND w.job_status='Assigned' AND w.approve_status='1' AND work_status='Completed' AND w.created_by=0 AND ".$sch;
								  // echo $cond;exit;
							   }
							   elseif($sch==''){
								 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND w.job_status='Assigned' AND w.approve_status='1' AND work_status='Completed' AND w.created_by=0";
							   }
							  ?>
                              <div class="table">
