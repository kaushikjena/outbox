                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                                    ...
                                    <tbody>
                                     <?php
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="AssignedDate"><?php echo ($res_JobBoard['assign_date']<>'0000-00-00' && $res_JobBoard['assign_date']<>NULL)? date("d-M-Y",strtotime($res_JobBoard['assign_date'])):'NIL';?></td>
                            ...
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"admin_total_job_report?srchClient=$_REQUEST[srchClient]&srchStatus=$_REQUEST[srchStatus]&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&");}?></div>
