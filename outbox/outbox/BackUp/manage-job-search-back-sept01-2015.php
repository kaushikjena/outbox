                        ...
                        <div class="spacer"></div>
                              <?php
								...
								if($_REQUEST['srchInputBox']!=''){
									...
									$sch=$sch."w.wo_no IN ($searchString) OR w.purchase_order_no IN ($searchString) OR w.work_status IN ($searchString) OR w.invoice_no IN ($searchString) OR c.name IN ($searchString) OR c.city IN ($searchString) OR s.service_name IN ($searchString) OR cl.name IN($searchString) OR temp.techname IN($searchString)";
									if($sch !=''){
