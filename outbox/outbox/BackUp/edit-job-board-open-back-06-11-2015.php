...
if(isset($_REQUEST['action']) && $_REQUEST['action']=="update" && $_SERVER['REQUEST_METHOD']=='POST'){
	...
	$string1="wo_no='$_REQUEST[WorkOrder]', purchase_order_no='$PurchaseOrder',   service_id='$_REQUEST[cmbService]',client_id='$clientid', pickup_location='$Pickuplocation', pickup_address='$Address', pickup_city='$City', pickup_state='$State', pickup_zip_code='$_REQUEST[Zip]', pickup_phone_no='$_REQUEST[Phone]', pickup_alt_phone='$_REQUEST[altPhone]',tracking_number='$_REQUEST[track_no]',carrier_company='$_REQUEST[carrier_company]', work_status='$_REQUEST[cmbStatus]', notes='$notes', created_by='$_REQUEST[cmbClient]', updated_date=now(), updated_by='$_SESSION[userid]'";
                        ...
                        <!-----Table area start------->
                           ...
                           <div class="spacer" style="height:12px;"></div>
                            ...
                            <div  class="divPickup">
                                ...
                                <div  class="textboxcjob">
                                    <input type="text" class="textboxjob" name="serial_number" id="serial_number"  maxlength="12" tabindex="12"><br/><label for="altSerial" id="lblserialNumber" class="redText"></label>
                                </div>
                                <div class="spacer"></div>
                                ...
                                <div  class="textboxcjob">
                                    <input type="text" class="textboxjob" name="model_number" id="model_number"  maxlength="12" tabindex="12"><br/><label for="altModel" id="lblmodelNumber" class="redText"></label>
                                </div>
                                <div class="spacer"></div>
