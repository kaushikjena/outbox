...
if($_REQUEST['action']=='insert'){
	...
	for($i=1;$i<=$count;$i++){
		...
		$num= $dbf->countRows("service_price","service_id='$_REQUEST[ServiceName]' AND equipment='$EquipmentName' AND work_type='$wotype'");
		if($num>0){
                            ...
                            <div class="spacer"></div>
                              ...
                              <input type="hidden" name="action" value="insert">
                                ...
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="OutBoxPrice<?php echo $i;?>" id="OutBoxPrice<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="OutBoxPrice" id="lblOutBoxPrice<?php echo $i;?>" class="redText"></label>
                                </div>
                                <div  class="textboxserprc">
