                        ...
                        <div id="contenttable">
                            ...
                            <form name="SrchFrm" id="SrchFrm" action="" method="post">
                              ...
                              <?php
							   ...
							   //echo $sch;exit;
							   if($sch!=''){
								 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND w.job_status='Assigned' AND w.approve_status='1' AND w.work_status='Completed' AND w.created_by<>0 AND ".$sch;
								  // echo $cond;exit;
							   }
							   elseif($sch==''){
								 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND w.job_status='Assigned' AND w.approve_status='1' AND w.work_status='Completed' AND w.created_by<>0";
							   }
							  ?>
                              <div class="table">
                                <div class="table-head">
                                    ...
                                    <div class="column" data-label="ServiceName" style="width:11%;">ServiceName</div>
                                    ...
                                    <div class="column" data-label="State" style="width:9%;">State</div>
                                    <div class="column" data-label="Clients" style="width:11%;">Clients</div>
                                    <div class="column" data-label="TechName" style="width:12%;">TechName</div>
								...
								<div class="row">
                                    ...
                                    <a href="view-job-board?id=<?php echo $res_JobBoard['id'];?>&src=clnt" title="Click Here For Job Details" style="color:<?php echo $color;?>"><?php echo $res_JobBoard['wo_no'];?></a></div>
                                    ...
                                    <div class="column" data-label="Action" align="center"><a href="admin-client-billings?id=<?php echo $res_JobBoard['id']?>">Generate</a>
                                    </div>
                               </div>
                               <?php $c++;}
								}
