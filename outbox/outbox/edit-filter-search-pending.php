...
$resFilterSearch = $dbf->fetchSingle("filter_search","user_type='$_SESSION[usertype]' AND user_id='$_SESSION[userid]' AND page_name='pendingboard'");
?>
<body>
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                    	<form name="SrchFrm" id="SrchFrm" action="manage-job-board-pending" method="post">
                        ...
                        <div class="headerbg">
                            ...
                            <div  style="float:left; text-transform:none; padding-left:100px;">( This filter applies to: Pending Board )</div>
                            ...
                            <input type="button" class="buttonText2" value="Return Back" onClick="document.location.href='manage-job-board-pending'"/></div>
                        </div>
                        ...
                        <div class="divFilterleft">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("assign_tech at,work_order wo,clients cl","wo.client_id=cl.id AND wo.work_status ='Pending' AND wo.wo_no=at.wo_no ","cl.name ASC","","cl.name")as $customer){?>
                        ...
                        <div class="divFiltercent2">
                            ...
                            <div class="divFilterconsec">
								...
								$cond = "wo.created_by=cl.id AND wo.created_by<>'0' AND wo.work_status ='Pending' AND wo.wo_no=at.wo_no ";
								//condition for users
								if($implode_clients <>''){
                        ...
                        <div class="divFiltercent _postright">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.work_status = 'Pending' AND w.approve_status='1' AND w.wo_no=at.wo_no AND at.tech_id=t.id ","w.id","w.wo_no")as $reswono){?>
                        ...
                        <div class="divFiltercent2">
							...
							$statusArray = ($resFilterSearch['status'] !='')?explode(",",$resFilterSearch['status']):array(); 							?>
                                ...
                                <div><input type="checkbox" name="search[srchStatus][]" value="Pending" <?php if(in_array("Pending",$statusArray,true)){echo "checked";}?>/> Pending </div>
                           	</div>
                        </div>
                        <div class="divFiltercent">
                        ...
                        <div class="divFiltercent _postright">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.work_status ='Pending' AND w.approve_status='1' AND w.wo_no=at.wo_no AND at.tech_id=t.id AND w.purchase_order_no <>''","w.id","w.purchase_order_no")as $respurno){?>
