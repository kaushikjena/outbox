         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg"><div style="float:left;">Manage COD Payments History</div>
                        	...
                        	<div style="width:100%;float:left;">
                              ...
                              <div style="margin-bottom:5px;" align="center">
                                  ...
                                  <div class="textboxcsrch">
                                   <select name="srchClient" id="srchClient" class="selectboxsrch">
                                        ...
                                        <?php foreach($dbf->fetch("cod_payment_history cp,clients c","cp.client_id=c.id GROUP BY c.id ORDER BY c.name ASC")as $client){?>
                              ...
                              <div class="table">
                                <div class="table-head">
                                    <div class="column" data-label="ClientName" style="width:14%;">COD Name</div>
                                    <div class="column" data-label="ClientEmail" style="width:15%;">COD Email</div>
                                    <div class="column" data-label="ClientState" style="width:11%;">COD State</div>
                                ...
                                <?php 
								$num=$dbf->countRows("state st,clients c,cod_payment_history cp",$cond); 
								foreach($dbf->fetchOrder("state st,clients c,cod_payment_history cp",$cond,"cp.id DESC","","")as $clntpayhistory){
									if($clntpayhistory['transaction_id']<>''){
										$transactionid = $clntpayhistory['transaction_id'];
									}else{
										$transactionid = "Offline Mode";
									}
								?>
								<div class="row">
                                    ...
                                    <div class="column" data-label="TransactionId"><?php echo $transactionid;?></div>
                                    ...
                                    <div class="column" data-label="Action" style="text-align:center;"><a href="view-cod-payments-history?id=<?php echo $clntpayhistory['id'];?>"><img src="images/view.png" title="View" alt="View"/></a></div>
                               </div>
                               <?php }?>
                        	</div>
