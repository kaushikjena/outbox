        ...
        <div class="technicianworkboard">
            <div class="rightcoluminner">
                ...
                <!-----Table area start------->
                    <!-----address div start--------->
                     <div  class="divTechworkStatus">
                       ...
                       <div style="padding-right:5px;">
						...
						$dbf->updateTable("workorder_doc","unread=1","wo_document='$_REQUEST[fname]' AND workorder_id='$_REQUEST[woid]'");
                    ...
                    <div class="spacer"></div>
                    <div align="center">
                     <input type="button"class="buttonText" value="Return Back" onclick="returnBack('<?php echo $_REQUEST['wono'];?>','<?php echo $_REQUEST['woid'];?>');"/>
                     </div>
                    <div class="spacer"></div>
                   <!-----Table area end------->
                </div>
