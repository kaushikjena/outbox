...
$filename = "technician_report.pdf";
$htmlFile = $baseUrl."tech/tech_report_pdf_data.php?srchCust=$_REQUEST[srchCust]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]&userid=$_SESSION[userid]";
