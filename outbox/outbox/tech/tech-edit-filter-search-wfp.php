         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                    	<form name="SrchFrm" id="SrchFrm" action="tech-manage-job-board-wfp" method="post">
                        ...
                        <div class="headerbg">
                            ...
                            <input type="button" class="buttonText2" value="Return Back" onClick="document.location.href='tech-manage-job-board-wfp'"/></div>
                        </div>
                        ...
                        <div class="divFilterleftOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order wo,clients cl","wo.client_id=cl.id AND wo.work_status ='WFP'","cl.name ASC","","cl.name")as $customer){?>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.work_status ='WFP' AND w.wo_no=at.wo_no AND at.tech_id=t.id AND t.id='$_SESSION[userid]'","w.id","w.wo_no")as $reswono){?>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("technicians t,assign_tech at,work_order w","w.work_status ='WFP' AND w.wo_no=at.wo_no AND at.tech_id=t.id AND t.id='$_SESSION[userid]' AND w.purchase_order_no <>''","w.id","w.purchase_order_no")as $respurno){?>
