...
function edit_filter(){
	window.location.href="tech-edit-filter-search-hold";
}
...
<script  type="text/javascript" src="../js/dragtable.js"></script>
	<form name="frmRedirect" id="frmRedirect" action="" method="post"> 
        ...
        <input type="hidden" name="src" id="src" value="hold"/>
    </form>
    <div id="maindiv">
        <!-------------header--------------->
            		...
            		<div class="rightcoluminner">
                    	<?php
						  ...
						  // echo $cond;exit;
							 ...
							 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND w.work_status='On Hold' AND w.wo_no=at.wo_no AND at.tech_id=t.id AND t.id='$_SESSION[userid]'";
						   }
						  // echo $cond;
                              ...
                              <!-----Table area start------->
                                <table id="no-more-tables" class="draggable">
								    ...
								    <?php
										...
										if($res_JobBoard['work_status']=='On Hold'){
