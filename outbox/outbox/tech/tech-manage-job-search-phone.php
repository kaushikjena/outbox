                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                              ...
                              <?php
							   	$sch1="";
								################Search Conditions for Phone Numbers#############
								if($_REQUEST['srchInputBoxphno']!=''){
									##########Search condition for assign jobs#################
									$sch1=$sch1."c.phone_no='$_REQUEST[srchInputBoxphno]' OR ";
							   ...
							   ##########Search condition for assign jobs#################
							   if($sch1!=''){
								 $cond1="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND (w.work_status='Assigned' OR w.work_status='Dispatched' OR w.work_status='In Progress' OR w.work_status='Scheduled' OR w.work_status='Completed' OR w.work_status='Ready to Invoice' OR w.work_status='Invoiced' OR w.work_status='Cancelled') AND w.approve_status='1' AND w.wo_no=at.wo_no AND at.tech_id=t.id AND t.id='$_SESSION[userid]' AND (".$sch1.")";
