...
header("Content-Disposition: attachment; Filename=tech_payment_report.doc");
?>	
<!--Important-->
       ...
       <table border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#808080" width="100%" style="border:solid 1px #999;"> 
        <thead>
          <tr bgcolor="#E6F9D5">
            ...
            <th width="15%" height="27" align="center" valign="middle" class="fetch_headers">Payment Status</th>
