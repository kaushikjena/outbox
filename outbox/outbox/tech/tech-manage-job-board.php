...
function Set_Workstatus_alert(v){
	if(v=='n'){
		...
		alert("Sorry !!! \n\nThis work is Completed or Invoiced or Cancelled.");
	}
}
            		...
            		<div class="rightcoluminner">
                    	<?php
						  ...
						  // echo $cond;exit;
							 ...
							 $cond="c.state=st.state_code AND c.id=w.client_id AND w.service_id=s.id AND (w.work_status='Assigned' OR w.work_status='Scheduled' OR w.work_status='Dispatched' ) AND w.wo_no=at.wo_no AND at.tech_id=t.id AND t.id='$_SESSION[userid]' AND (at.start_date=CURDATE() OR at.start_date='0000-00-00')";
						   }
						  // echo $cond;
						  ...
						  ?>
                        <div class="headerbg">
                        	<div style="float:left; width:30%;">Dispatch Board</div>
                              ...
                              <!-----Table area start------->
                                <table id="no-more-tables" class="draggable">
								    ...
								    <?php
										...
										if($res_JobBoard['work_status']=='Completed' || $res_JobBoard['work_status']=='Invoiced' || $res_JobBoard['work_status']=='Ready to Invoice' || $res_JobBoard['work_status']=='Cancelled'){
