...
$res_techWorkorder=$dbf->strRecordID("work_order w","wo_no, service_id, work_status, serial_number, model_number, parts_status, parts_needed_comments","w.id='".$_REQUEST['woid']."'");
//print "<pre>"; print_r($res_techWorkorder);
...
if($_REQUEST['action']=="insert"){
	 ...
	 $parts_needed_comments= mysql_real_escape_string($_REQUEST['parts_needed_comments']);
	//update work_order table
	 $string="work_status='".$_REQUEST['cmbStatus']."', serial_number='".$_REQUEST['SerialNumber']."', model_number='".$_REQUEST['ModelNumber']."', parts_status='".$_REQUEST['partStatus']."',parts_needed_comments='".$parts_needed_comments."', updated_date=now(),updated_by='".$_SESSION['userid']."'";
	 ...
	 $insertid =$dbf->insertSet("work_order_tech",$string1);
	 ###################Track notes in the work order notes table################################
	 if($insertid){
		$techNotes="The order status is changed into ".$_REQUEST['cmbStatus'].".";
		$strnotes="workorder_id='".$_REQUEST['woid']."', user_type='".$_SESSION['usertype']."', user_id='".$_SESSION['userid']."', wo_notes='".$techNotes."',read_status='1',created_date=now()";
    ...
    <div  style="margin:2px;">
        ...
        <div class="technicianworkboard">
            <div class="rightcoluminner">
                <div class="headerbg">Technician Order Status</div>
                <div class="spacer"></div>
                <div id="contenttable" style="max-height:500px;">
                <!-----Table area start------->
                  <form name="frmTechStatus" id="frmTechStatus" action="tech-workorder-status" method="post" onSubmit="return validate_techStatus();" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <!-----address div start--------->
                     <div  class="divTechworkStatus">
                        <div class="greenText" align="left">Order Details:</div>
                        ...
                        <div  class="formtextaddjoblarge">Order Status:<span class="redText">*</span></div>
                        <div  class="textboxcjob">
                        <select name="cmbStatus" id="cmbStatus"class="selectboxjob">
                            <option value="">--Select Status--</option>
                            <option value="Dispatched" <?php if($res_techWorkorder['work_status']=='Dispatched'){echo 'selected';}?>>Dispatched</option>
                            <option value="In Progress" <?php if($res_techWorkorder['work_status']=='In Progress'){echo 'selected';}?>>In Progress</option>
                            <option value="Completed" <?php if($res_techWorkorder['work_status']=='Completed'){echo 'selected';}?>>Completed</option>
                       ...
                       <div class="spacer"></div>
                        <div  class="formtextaddjoblarge">Serial Number:<span class="redText">*</span></div>
                        <div  class="textboxcjob"><input type="text" class="textboxjob" name="SerialNumber" id="SerialNumber"  value="<?php echo $res_techWorkorder['serial_number'];?>"><br/><label for="SerialNumber" id="lblSerialNumber" class="redText"></label></div>
                       <div  class="formtextaddjoblong">Model Number:<span class="redText">*</span></div>
                       <div  class="textboxcjob"><input type="text" class="textboxjob" name="ModelNumber" id="ModelNumber" value="<?php echo $res_techWorkorder['model_number'];?>"><br/><label for="ModelNumber" id="lblModelNumber" class="redText"></label></div>                    
                       <div class="spacer"></div>
                       <div  class="formtextaddjoblarge">Parts Status:<span class="redText">*</span></div>
                       <div  class="textboxcjob">
                        <select name="partStatus" id="partStatus"class="selectboxjob">
                            <option value="">--Select Parts Status--</option>
                            <option value="1" <?php if($res_techWorkorder['parts_status']==1){echo 'selected';}?>>Parts Needed</option>
                            <option value="2" <?php if($res_techWorkorder['parts_status']==2){echo 'selected';}?>>No More Parts Needed</option>
                       </select>
                       <br/><label for="PartStatus" id="lblPartStatus" class="redText"></label></div>     
                       <div class="spacer"></div>
                       <div class="spacer" style="height:5px;"></div>
                       <div class="greenText" align="left">Parts Needed Comments:</div>
                       <div><textarea name="parts_needed_comments" id="parts_needed_comments" class="textareaOrder"><?php echo $res_techWorkorder['parts_needed_comments'];?></textarea><br/><label for="techNotes" id="lbltechNotes" class="redText"></label></div>
                       <div class="spacer" style="height:5px;"></div>
