...
$filename = "admin_servcie_billing_report.pdf";
//$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."admin_service_billing_report_pdf_data.php?srchCust=$_REQUEST[srchCust]&srchClient=$creatorlist&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
