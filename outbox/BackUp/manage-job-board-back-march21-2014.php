                                     ...
                                     <?php 
									  ...
									  ?>
                                    	...
                                    	<tr class="<?php echo $Cls;?>" <?php if($k!=0){?> style="display:none;" <?php } ?>>
                                            ...
                                            <td data-title="Action"><a href="edit-job-board?id=<?php echo $res_JobBoard['id']?>"><img src="images/edit.png" title="Edit" alt="Edit"/></a>&nbsp;<a href="view-job-board?id=<?php echo $res_JobBoard['id'];?>"><img src="images/view.png" title="View" alt="View"/></a>&nbsp;<a href="manage-job-board?action=delete&id=<?php echo $res_JobBoard['id'];?>" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="images/delete.png" title="delete" alt="delete"></a>&nbsp;<a href="manage-job-board?action=email&id=<?php echo $res_JobBoard['id'];?>" onClick="return confirm('Are you sure you want to send email ?')"><img src="images/email_go.png" title="Send Email" alt="Email"></a></td>
                                        </tr>
                                         <?php } 
											}
										?> 
