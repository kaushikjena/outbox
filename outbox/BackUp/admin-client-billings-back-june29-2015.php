...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='payment'){
		...
		$email_body=str_replace(array('%ClientName%','%BillPeriod%','%WoNo%','%Subtotal%','%ActivationLink%'),array($codname,$_REQUEST['billperiod'],$_REQUEST['wonos'],number_format($_REQUEST['amount'],2),$activateUrl),$input);
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <!-----Table area start------->
                         ...
                         <div  class="divBilling">
						<?php
						 $cond="c.id=w.client_id AND w.service_id=s.id AND w.approve_status='1' AND w.work_status='Completed' AND w.created_by<>0 AND at.wo_no=w.wo_no AND at.tech_id=t.id AND FIND_IN_SET(w.wo_no,'$implode_workorders')";
						 //echo $cond;
