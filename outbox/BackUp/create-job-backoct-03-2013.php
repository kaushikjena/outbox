...
<body onLoad="document.createJob.WorkOrder.focus();">
    <div id="maindiv">
        <!-------------header--------------->
            		...
            		<div class="rightcoluminner">
                        ...
                        <!-----Table area start------->
                          <form name="createJob" id="createJob" action="" method="post" onSubmit="return validate_createjob();" autocomplete="off">
                            ...
                            <div  class="formtextaddjoblong">Purchase Order: <span class="smallText">(Optional)</span></div>
                            <div  class="textboxcjob">
