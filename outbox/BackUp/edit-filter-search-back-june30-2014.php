            		...
            		<div class="rightcoluminner">
                        ...
                        <div class="divFilterleft">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order wo,clients cl","wo.client_id=cl.id AND wo.job_status='Assigned'","cl.name ASC","","cl.name")as $customer){?>
                        ...
                        <div class="divFiltercent2">
                            ...
                            <div class="divFilterconsec">
								...
								$cond = "wo.created_by=cl.id AND wo.created_by<>'0' AND wo.job_status='Assigned'";
								//condition for users
								if($implode_clients <>''){
									$cond.=" AND FIND_IN_SET(cl.id,'$implode_clients')";
								}
								foreach($dbf->fetchOrder("work_order wo,clients cl",$cond,"cl.name ASC","","cl.name")as $client){ ?>
                        ...
                        <div class="divFiltercent2">
							...
							$jobstatusArray = ($resFilterSearch['job_status'] !='')?explode(",",$resFilterSearch['job_status']):array();
							?>
                            	<div><input type="checkbox" name="search[srchJobStatus][]" value="Cancelled" <?php if(in_array("Cancelled",$jobstatusArray,true)){echo "checked";}?>/> Show Cancelled</div>
                        ...
                        <div class="divFiltercent">
                       	...
                       	<div class="divFilterleft">
                            ...
                            <?php $columnorderArray = ($resFilterSearch['column_order'] !='')?explode(",",$resFilterSearch['column_order']):array(); ?>
                                ...
                                <div><input type="checkbox" name="search[columnOrder][]" value="w.work_status" <?php if(in_array("w.work_status",$columnorderArray,true)){echo "checked";}?>> WorkStatus</div>
