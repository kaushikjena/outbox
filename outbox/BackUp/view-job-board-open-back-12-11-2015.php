...
//GET PARTS ARRIVE
$parts_arrive =(($res_viewJobBoard['parts_arrive']=='twodays')?"2 Days":(($res_viewJobBoard['parts_arrive']=='threedays')?"3 Days":(($res_viewJobBoard['parts_arrive']=='fourdays')?"4 Days":(($res_viewJobBoard['parts_arrive']=='Partsarrive')?"Parts have Arrived":""))));
?>
                        ...
                        <!-----Table area start------->
                           ...
                           <div class="spacer"></div>
                            ...
                            <div  class="divPickup">
                                ...
                                <div  class="textboxjobview">&nbsp;<?php echo $parts_arrive;?></div>
                                <div class="spacer"></div>
