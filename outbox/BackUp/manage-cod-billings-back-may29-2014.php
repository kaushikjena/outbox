                              ...
                              <div style="margin-bottom:5px;" align="center">
                                  ...
                                  <div class="textboxcsrch">
                                    <select name="srchCust" id="srchCust" class="selectboxsrch">
                                        ...
                                        <?php foreach($dbf->fetchOrder("work_order wo,clients cl","wo.client_id=cl.id AND wo.job_status='Assigned' AND wo.approve_status='1' AND wo.work_status='Completed'","cl.name ASC","","cl.name")as $customer){?>
