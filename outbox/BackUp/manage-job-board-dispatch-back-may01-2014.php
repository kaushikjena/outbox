...
function print_doc(val,woid){
	...
	if(val=='pdf'){
		window.open("admin_job_board_pdf.php?id="+woid);
    }
}
/*********Function to print job************/
</script>
                               ...
                               <div  class="formtextaddsrch" align="center">Customer</div>
                                  <div class="textboxcsrch">
                                    <select name="srchCust" id="srchCust" class="selectboxsrch">
                                        ...
                                        <option value="<?php echo $customer['id']?>" <?php if($customer['id']==$_SESSION['request']['srchCust']){echo 'selected';}?>><?php echo $customer['name'];?></option>
                                        <?php }?>
                                   </select>
                                  </div>
                                  ...
                                  <div class="textboxcsrch">
                                    <select name="srchClient" id="srchClient" class="selectboxsrch">
                                        ...
                                        <option value="0" <?php if($_SESSION['request']['srchClient']=="0"){echo 'selected';}?>> COD </option>
                                        ...
                                        <option value="<?php echo $client['id']?>" <?php if($client['id']==$_SESSION['request']['srchClient']){echo 'selected';}?>><?php echo $client['name'];?></option>
                                        <?php }?>
                                   </select>
                                  </div>
                                  ...
                                  <div class="textboxcsrch">
                                        <select name="srchTechnician" id="srchTechnician" class="selectboxsrch">
                                            ...
                                            <option value="<?php echo $tech['id']?>" <?php if($tech['id']==$_SESSION['request']['srchTechnician']){echo 'selected';}?>><?php echo $tech['first_name'].'&nbsp;'.$tech['middle_name'].'&nbsp;'.$tech['last_name'];?></option>
                                            <?php }?>
                                        </select>
                                   </div>
                                  ...
                                  <div class="textboxcsrch">
                                        <select name="srchService" id="srchService" class="selectboxsrch">
                                            ...
                                            <option value="<?php echo $service['id'];?>" <?php if($service['id']==$_SESSION['request']['srchService']){echo 'selected';}?>><?php echo $service['service_name'];?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                  ...
                                  <div class="textboxcsrch">
                                        <select name="srchStatus" id="srchStatus"class="selectboxsrch">
                                            ...
                                            <option value="Dispatched" <?php if($_SESSION['request']['srchStatus']=='Dispatched'){echo 'selected';}?>>Dispatched</option>
                                            <option value="In Progress" <?php if($_SESSION['request']['srchStatus']=='In Progress'){echo 'selected';}?>>In Progress</option>
                                            <option value="Completed" <?php if($_SESSION['request']['srchStatus']=='Completed'){echo 'selected';}?>>Completed</option>
                                            <option value="Invoiced" <?php if($_SESSION['request']['srchStatus']=='Invoiced'){echo 'selected';}?>>Invoiced</option>
                                        </select>
                                    </div>
                                  <div  class="formtextaddsrchsmall"align="center">From:</div>
                                  <div class="textboxcsrchsmall">
                                      <input type="text" class="textboxsrch datepick" name="FromDate" id="FromDate" value="<?php echo $_SESSION['request']['FromDate'];?>" readonly>
                                  </div>
                                  <div  class="formtextaddsrchsmall"align="center">To:</div>
                                  <div class="textboxcsrchsmall">
                                      <input type="text" class="textboxsrch datepick" name="ToDate" id="ToDate" value="<?php echo $_SESSION['request']['ToDate'];?>" readonly>
                                  </div>
                                  </div>
                                  <div class="spacer"></div>
