...
$htmlFile = $baseUrl."admin_total_job_report_pdf_data.php?srchClient=$creatorlist&srchStatus=$workstatuslist&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&hidaction=$_REQUEST[hidaction]";
