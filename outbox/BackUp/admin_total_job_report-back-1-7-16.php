<?php
	...
	//echo $first."<br/>".$last;exit;
	//$query_date = '2016-06';
	//First day of the month.
	//echo date('Y-m-01', strtotime($query_date));
    //Last day of the month.
    //echo "<br/>".date('Y-m-t', strtotime($query_date));exit;s
	//echo $query_date = "'".$_REQUEST['srchMonth']."'";
	//First day of the month.
	/*$query_date='2015-09';
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                              ...
                              <div style="margin-bottom:5px;" align="center">
                                  ...
                                  <select name="srchClient[]" id="srchClient" class="selectboxsrch" style="height:auto;" multiple="multiple">
                                   ...
                                   <!-- <option value="">--Select Status--</option>-->
                                    ...
                                    <div class="textboxcsrch">
                                    <?php //$sql="SELECT created_date FROM work_order ORDER BY created_date ASC LIMIT 0,1";
										  //$res=$dbf->simpleQuery($sql);
										  //print'<pre>';print_r($res[0]['created_date']); 
										  //$oldyear=date("Y",strtotime($res[0]['created_date'])); 
										  //$oldmonth=date("m",strtotime($res[0]['created_date'])); 	
                                    ...
                                    <select name="srchMonth" id="srchMonth" class="selectboxsrch">
										...
										?>
                                        <option value="<?php echo $i.'-'.$j;?>" <?php //if($currentmonth==$j && $curyear){echo "selected";}
										if($_REQUEST['srchMonth']==$i.'-'.$j){echo 'selected';}
                            ...
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"admin_total_job_report?srchClient=$creatorlist&srchStatus=$workstatuslist&srchTechnician=$_REQUEST[srchTechnician]&srchService=$_REQUEST[srchService]&FromDate=$_REQUEST[FromDate]&ToDate=$_REQUEST[ToDate]&");}?></div>
