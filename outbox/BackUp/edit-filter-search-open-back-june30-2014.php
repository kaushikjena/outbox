            		...
            		<div class="rightcoluminner">
                        ...
                        <div class="divFilterleftOpen">
                            ...
                            <div class="divFilterconsec">
								...
								foreach($dbf->fetchOrder("work_order wo,clients cl","wo.client_id=cl.id AND wo.job_status='Open'","cl.name ASC","","cl.name")as $customer){?>
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
								...
								$cond="wo.created_by=cl.id AND wo.created_by<>'0' AND wo.job_status='Open'";
								//condition for users
								if($implode_clients <>''){
                        ...
                        <div class="divFiltercentOpen">
                            ...
                            <div class="divFilterconsec">
                               ...
                               <div style="float:right; padding-right:100px; cursor:pointer;"><img src="images/delete.png" alt="Delete" title="Remove Dates" onClick="clearDates();"/></div> 
                           	</div>
                        </div>
                       	<div class="divFilterleftOpen">
