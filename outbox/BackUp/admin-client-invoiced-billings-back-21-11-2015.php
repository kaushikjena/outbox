...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='payment'){
		...
		$email_body=str_replace(array('%ClientName%','%BillPeriod%','%WoNo%','%Subtotal%','%ActivationLink%'),array($codname,"Nill",$_REQUEST['wonos'],number_format($_REQUEST['amount'],2),$activateUrl),$input);
