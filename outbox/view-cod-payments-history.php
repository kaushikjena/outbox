...
$viewClntPayhist=$dbf->fetchSingle("state st,cod_payment_history cp,clients c","c.id=cp.client_id AND st.state_code=c.state AND cp.id='$_REQUEST[id]'");
if($viewClntPayhist['transaction_id']<>''){
	$transactionid = $viewClntPayhist['transaction_id'];
}else{
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg">View COD Payments History</div>
                        ...
                        <div  class="innertable">
                                ...
                                <div  class="textboxview"><?php echo $transactionid;?></div>
                                <div class="spacer"></div>
                                ...
                                <div class="spacer"></div>
                                <div align="center"  style="padding-right:60px;"><input type="button" class="buttonText" value="Return Back" onClick="window.location='manage-cod-payments-history'"/>
                                 </div>
                        	</div>
                            <!-----Table area start-------> 
                        	<div class="spacer"></div>
