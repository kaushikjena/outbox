<?php 
	...
	if($_REQUEST['action']=='delete'){	
		...
		if($c_data){
			header("Location:manage-technician-active?msg=004");exit;
		}else{
			...
			header("Location:manage-technician-active");exit;
		}
	}
...
function delete_tech(id){
	...
	<form name="frmRedirect" id="frmRedirect" action="" method="post"> 
        ...
        <input type="hidden" name="src" id="src" value="active"/>
    </form>
    <div id="maindiv">
        <!-------------header--------------->
            		...
            		<div class="rightcoluminner">
                        ...
                        <div id="contenttable">
                            ...
                            <div class="spacer"></div>
                             <?php
							 	//condition
								$cond = "t.state=s.state_code AND t.status=1"; 
								if($implode_techs <>''){
                            ...
                            <?php }?>
                            <div  align="center"><?php if($num>0) { echo $dbf->Pages($num,$perpage,"manage-technician-active?");}?></div>
                          </div>
                        </div>
                        <div class="spacer"></div>
                    </div>
