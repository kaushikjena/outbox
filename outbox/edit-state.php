...
$res_state=$dbf->fetchSingle("state","id='$_REQUEST[id]'");
if($_REQUEST['action']=="update"){
	    $num=$dbf->countRows("state","(state_code='$_REQUEST[ProfileStateCode]' OR state_name='$_REQUEST[ProfileStateName]') AND id!='$_REQUEST[id]'");
		if($num>0){
			header("Location:edit-state?id=$_REQUEST[hid]&msg=002");exit;
		}else{
			//update into State table
			$string="state_code='$_REQUEST[ProfileStateCode]',state_name='$_REQUEST[ProfileStateName]',created_date=now()";
			$dbf->updateTable("state",$string,"id='$_REQUEST[hid]'");
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolum">
            		<div class="rightcoluminner">
                        <div class="headerbg">EDIT STATE</div>
                        ...
                        <div id="contenttable">
                            ...
                            <div class="spacer"></div>
                              ...
                              <input type="hidden" name="hid" value="<?php echo $_REQUEST['id'];?>">
                                ...
                                <div  class="textboxc">
                                    <input type="text" class="textbox" name="ProfileStateCode" id="ProfileStateCode" value="<?php echo $res_state['state_code'];?>"><br/><label for="ProfileStateCode" id="lblProfileStateCode" class="redText"></label>
                               </div>
                               <div class="spacer"></div>
                               <div  class="formtextadd">State Name<span class="redText">*</span></div>
                                <div  class="textboxc">
                                    <input type="text" class="textbox" name="ProfileStateName" id="ProfileStateName" value="<?php echo $res_state['state_name'];?>"><br/><label for="ProfileStateName" id="lblProfileStateName" class="redText"></label>
                               </div>
                              <div class="spacer"></div>
                                 <div align="center">
