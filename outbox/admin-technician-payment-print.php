	  ...
	  <?php 
        ...
        <table  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#808080" width="100%" style="border:solid 1px #999;">
          	 <tr>
                ...
                <td width="50%" align="center" valign="middle" class="fetch_contents"><b>Payment For Period <?php echo $_REQUEST['billperiod'];?></b></td>
              ...
              <tr>
               ...
               <tr>
                ...
                <td align="left" valign="top" class="fetch_contents">Completed</td>
                <td height="25" align="left" valign="top" class="fetch_contents">Bill Period:</td>
                <td height="25" align="left" valign="top" class="fetch_contents"><b><?php echo $_REQUEST['billperiod'];?></b></td>
              </tr>
          </table><br/>
        <?php
