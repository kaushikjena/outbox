         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner">
                        <div class="headerbg">
                        	<div style="float:left;">Add Client Billing Price</div>
                              ...
                              <input type="hidden" name="action" value="insert">
                               <div style="float:left; width:40%;">
                                ...
                                <select class="selectbox" name="ClientName" id="ClientName" onChange="showServices();">
                                    ...
                                    <option value="<?php echo $valclient['id'];?>"><?php echo $valclient['name'];?></option>
                                    <?php }?>
                                ...
                                <div  class="textboxserprc">
                                    <input type="text" class="textboxjob" name="ClientPrice<?php echo $i;?>" id="ClientPrice<?php echo $i;?>" onKeyUp="return extractNumber(this,2);" maxlength="8"><br/><label for="ClientPrice" id="lblClientPrice<?php echo $i;?>" class="redText"></label>
                                </div>
                                 <div  class="textboxserprc">
