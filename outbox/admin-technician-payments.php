...
function sendInvoicedEmail(){
	...
	var wonos=$('#wonos').val();
	if(x){
		$.post(url,{"choice":"send_email","wonos":wonos,"billperiod":billperiod,"tid":tid},function(res){ 
			//alert(res);
        ...
        <!-------------top menu--------------->
         ...
         <div id="contentdiv">
                ...
                <div class="rightcolumjobboard">
            		<div class="rightcoluminner" style="color:">
                        <div class="headerbg">
                                ...
                                <?php 
                                    ...
                                    foreach($resArray as $key=>$res_clientBill) { 
										...
										foreach($res_woservice as $resServicePrice){
											...
											//$total = ($resServicePrice['quantity']*$price);//commented on 24th nov 2014
